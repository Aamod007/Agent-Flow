...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-indigo-500 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-95",
  {
    variants: {
      variant: {
        default:
          "bg-indigo-600 text-zinc-100 shadow hover:bg-indigo-500",
        destructive:
          "bg-red-600 text-zinc-100 shadow-sm hover:bg-red-500",
        outline:
          "border border-zinc-800 bg-transparent text-zinc-100 shadow-sm hover:bg-zinc-800 hover:text-zinc-100",
        secondary:
